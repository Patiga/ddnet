#![allow(unused)]
/// File copied from https://github.com/heinrich5991/ddnet/blob/45dd5c0ab9d2b4c0666b3aeb4037b7beff108956/src/net/src/key.rs
...
macro_rules! bail {
    ($($arg:tt)*) => {
        return Err(Error::from_string(format!($($arg)*)))
    }
}
...
pub trait Context {
    type T;
    fn context(self, context: &str) -> Result<Self::T, Error>;
}
